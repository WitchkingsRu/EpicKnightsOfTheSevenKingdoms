...
public class ArmorConfig implements ConfigData
{
    ...
    public Map<String, ArmorTypeConfig> armor = new LinkedHashMap<>() {{
        ...
        put("gold_cloak_armor", ArmorTypeConfig.of(0.50f, 0.1f, new Integer[] { 210, 300, 320, 250 }, new Integer[] { 2, 5, 7, 2 }, 9, true));
        put("gold_cloak_officer_armor", ArmorTypeConfig.of(0.50f, 0.1f, new Integer[] { 235, 315, 340, 275 }, new Integer[] { 3, 5, 8, 3 }, 9, true));
        ...
        put("dornish_prince_armor", ArmorTypeConfig.of(0.50f, 0.0f, new Integer[] { 235, 315, 340, 275 }, new Integer[] { 3, 5, 8, 3 }, 9, true));
        put("northern_armor", ArmorTypeConfig.of(0.50f, 0.0f, new Integer[] { 200, 235, 290, 240 }, new Integer[] { 3, 5, 6, 2 }, 9, true));
        put("plate_northern_armor", ArmorTypeConfig.of(0.50f, 0.0f, new Integer[] { 235, 315, 340, 275 }, new Integer[] { 3, 5, 8, 3 }, 9, true));
        put("greyjoy_armor", ArmorTypeConfig.of(0.50f, 0.0f, new Integer[] { 200, 235, 290, 240 }, new Integer[] { 3, 4, 6, 2 }, 9, true));
        put("rich_greyjoy_armor", ArmorTypeConfig.of(0.50f, 0.0f, new Integer[] { 235, 315, 340, 275 }, new Integer[] { 3, 5, 8, 3 }, 9, true));
        ...
        put("hotd_aegon_crown", ArmorTypeConfig.of(0.00f, 0.0f, new Integer[] { 0, 0, 0, 5000 }, new Integer[] { 0, 0, 0, 2 }, 25, true));
        put("jaehaerys_crown", ArmorTypeConfig.of(0.00f, 0.0f, new Integer[] { 0, 0, 0, 5000 }, new Integer[] { 0, 0, 0, 2 }, 25, true));
        put("hotd_jaehaerys_crown", ArmorTypeConfig.of(0.00f, 0.0f, new Integer[] { 0, 0, 0, 5000 }, new Integer[] { 0, 0, 0, 2 }, 25, true));
        put("aegon_dragonsbane_crown", ArmorTypeConfig.of(0.00f, 0.0f, new Integer[] { 0, 0, 0, 5000 }, new Integer[] { 0, 0, 0, 2 }, 25, true));
        put("aegon_unworthy_crown", ArmorTypeConfig.of(0.00f, 0.0f, new Integer[] { 0, 0, 0, 5000 }, new Integer[] { 0, 0, 0, 2 }, 25, true));
        put("maekar_crown", ArmorTypeConfig.of(0.00f, 0.0f, new Integer[] { 0, 0, 0, 5000 }, new Integer[] { 0, 0, 0, 2 }, 25, true));
        put("high_septon_crown", ArmorTypeConfig.of(0.00f, 0.0f, new Integer[] { 0, 0, 0, 5000 }, new Integer[] { 0, 0, 0, 2 }, 25, true));
        put("robert_crown", ArmorTypeConfig.of(0.00f, 0.0f, new Integer[] { 0, 0, 0, 5000 }, new Integer[] { 0, 0, 0, 2 }, 25, true));
        put("stannis_crown", ArmorTypeConfig.of(0.00f, 0.0f, new Integer[] { 0, 0, 0, 5000 }, new Integer[] { 0, 0, 0, 2 }, 25, true));
        put("renly_crown", ArmorTypeConfig.of(0.00f, 0.0f, new Integer[] { 0, 0, 0, 5000 }, new Integer[] { 0, 0, 0, 2 }, 25, true));
        put("stark_crown", ArmorTypeConfig.of(0.00f, 0.0f, new Integer[] { 0, 0, 0, 5000 }, new Integer[] { 0, 0, 0, 2 }, 25, true));
        put("driftwood_crown", ArmorTypeConfig.of(0.00f, 0.0f, new Integer[] { 0, 0, 0, 5000 }, new Integer[] { 0, 0, 0, 2 }, 25, true));
        ...
        put("fur_cape_pale", ArmorTypeConfig.of(0.00f, 0.0f, new Integer[] { 0, 0, 180, 0 }, new Integer[] { 0, 0, 0, 0 }, 9, true));
        put("fur_cape_white", ArmorTypeConfig.of(0.00f, 0.0f, new Integer[] { 0, 0, 180, 0 }, new Integer[] { 0, 0, 0, 0 }, 9, true));
        put("fur_cape_black", ArmorTypeConfig.of(0.00f, 0.0f, new Integer[] { 0, 0, 180, 0 }, new Integer[] { 0, 0, 0, 0 }, 9, true));
        put("fur_cape_woods", ArmorTypeConfig.of(0.00f, 0.0f, new Integer[] { 0, 0, 180, 0 }, new Integer[] { 0, 0, 0, 0 }, 9, true));
