...
public class RichGreyjoyArmorModel {
    public static LayerDefinition createLayer() {
        ...
        PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.3F, -1.5F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, -4.0F, -0.2182F, 0.0F, 0.0F));
        ...
        PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(16, 16).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.61F))
                .texOffs(0, 47).addBox(-4.0F, 10.8F, -2.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.76F))
                .texOffs(16, 33).addBox(-3.5F, 0.5F, -2.0F, 7.0F, 10.0F, 4.0F, new CubeDeformation(0.7F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition cube_r5 = right_arm.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(39, 58).addBox(-3.0F, -2.3F, -1.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.58F)), PartPose.offsetAndRotation(0.0F, 0.0F, -1.0F, 0.0F, 0.0F, -0.1309F));

        PartDefinition cube_r6 = right_arm.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(38, 46).addBox(-2.2F, -2.5F, -1.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.6F)), PartPose.offsetAndRotation(-1.0F, 0.0F, -1.0F, 0.0F, 0.0F, -0.1309F));
        ...
        PartDefinition cube_r7 = left_arm.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(39, 58).mirror().addBox(-1.0F, -2.3F, -1.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.58F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, -1.0F, 0.0F, 0.0F, 0.1309F));

        PartDefinition cube_r8 = left_arm.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(38, 46).mirror().addBox(-1.8F, -2.5F, -1.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.6F)).mirror(false), PartPose.offsetAndRotation(2.0F, 0.0F, -1.0F, 0.0F, 0.0F, 0.1309F));
        ...
        PartDefinition cube_r9 = right_leg.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(15, 55).addBox(-3.0F, -3.3F, -1.5F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.17F)), PartPose.offsetAndRotation(-0.1F, 3.0F, -1.0F, 0.0F, 0.0F, 0.0873F));
        ...
        PartDefinition cube_r10 = left_leg.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(15, 55).mirror().addBox(-2.0F, -3.3F, -1.5F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.17F)).mirror(false), PartPose.offsetAndRotation(1.1F, 3.0F, -1.0F, 0.0F, 0.0F, -0.0873F));
