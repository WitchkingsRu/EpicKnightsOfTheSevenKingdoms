...
public class WeirwoodArrowRender extends ArrowRenderer<WeirwoodArrowEntity> {
    public static final ResourceLocation NORMAL_ARROW_LOCATION = new ResourceLocation(ASOIAFMod.MOD_ID, "textures/entity/projectiles/weirwood_arrow.png");
    public static final ResourceLocation TIPPED_ARROW_LOCATION = new ResourceLocation(ASOIAFMod.MOD_ID, "textures/entity/projectiles/weirwood_arrow.png");
