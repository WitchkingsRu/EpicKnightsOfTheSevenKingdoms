...
public class ValyrianArmorModel {
    public static LayerDefinition createLayer() {
        ...
        PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 43).addBox(-4.0F, 1.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(1.01F))
                .texOffs(0, 0).addBox(-4.0F, 1.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.8F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(24, 0).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(1.0F))
                .texOffs(32, 33).addBox(-3.0F, 8.0F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(1.01F))
                .texOffs(0, 25).addBox(-1.2F, -4.0F, -3.5F, 1.0F, 4.0F, 7.0F, new CubeDeformation(0.3F))
                .texOffs(1, 16).addBox(-4.75F, -3.0F, -3.0F, 5.0F, 3.0F, 6.0F, new CubeDeformation(0.25F))
                .texOffs(32, 39).addBox(-3.25F, 2.6F, -2.5F, 3.0F, 2.0F, 5.0F, new CubeDeformation(1.0F)), PartPose.offset(-5.0F, 2.0F, 0.0F));

        PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(24, 0).mirror().addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(1.0F)).mirror(false)
                .texOffs(32, 33).mirror().addBox(-0.25F, 8.0F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(1.01F)).mirror(false)
                .texOffs(0, 25).mirror().addBox(0.2F, -4.0F, -3.5F, 1.0F, 4.0F, 7.0F, new CubeDeformation(0.3F)).mirror(false)
                .texOffs(32, 39).mirror().addBox(0.25F, 2.6F, -2.5F, 3.0F, 2.0F, 5.0F, new CubeDeformation(1.0F)).mirror(false)
                .texOffs(1, 16).mirror().addBox(-0.25F, -3.0F, -3.0F, 5.0F, 3.0F, 6.0F, new CubeDeformation(0.25F)).mirror(false), PartPose.offset(5.0F, 2.0F, 0.0F));
