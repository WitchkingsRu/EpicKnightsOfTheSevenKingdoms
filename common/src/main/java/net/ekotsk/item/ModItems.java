...
public class ModItems extends ModItemsProvider {
    ...
    public static final RegistrySupplier<DyeableArmorDecorationItem> FUR_CAPE_DECORATION = INSTANCE.addDyeableArmorDecorationItem("fur_cape_decoration", () -> new DyeableArmorDecorationItem(new ResourceLocation(ASOIAFMod.MOD_ID, "fur_cape"), new Item.Properties(), ArmorItem.Type.CHESTPLATE, 0xFFFFFF));
