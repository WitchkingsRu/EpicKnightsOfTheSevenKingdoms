...
public class ModItems extends ModItemsProvider {
    ...
    public static final RegistrySupplier<DyeableArmorDecorationItem> PALE_FUR_CAPE_DECORATION = INSTANCE.addDyeableArmorDecorationItem("fur_cape_pale_decoration", () -> new DyeableArmorDecorationItem(new ResourceLocation(ASOIAFMod.MOD_ID, "fur_cape_pale"), new Item.Properties(), ArmorItem.Type.CHESTPLATE, 0xFFFFFF));
    public static final RegistrySupplier<DyeableArmorDecorationItem> WOODS_FUR_CAPE_DECORATION = INSTANCE.addDyeableArmorDecorationItem("fur_cape_woods_decoration", () -> new DyeableArmorDecorationItem(new ResourceLocation(ASOIAFMod.MOD_ID, "fur_cape_woods"), new Item.Properties(), ArmorItem.Type.CHESTPLATE, 0xFFFFFF));
    public static final RegistrySupplier<DyeableArmorDecorationItem> WHITE_FUR_CAPE_DECORATION = INSTANCE.addDyeableArmorDecorationItem("fur_cape_white_decoration", () -> new DyeableArmorDecorationItem(new ResourceLocation(ASOIAFMod.MOD_ID, "fur_cape_white"), new Item.Properties(), ArmorItem.Type.CHESTPLATE, 0x000000));
    public static final RegistrySupplier<DyeableArmorDecorationItem> BLACK_FUR_CAPE_DECORATION = INSTANCE.addDyeableArmorDecorationItem("fur_cape_black_decoration", () -> new DyeableArmorDecorationItem(new ResourceLocation(ASOIAFMod.MOD_ID, "fur_cape_black"), new Item.Properties(), ArmorItem.Type.CHESTPLATE, 0xFFFFFF));
