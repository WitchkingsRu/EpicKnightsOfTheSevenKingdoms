...
public class ModItems extends ModItemsProvider {
    ...
    public static final @Nullable RegistrySupplier<DyeableMedievalArmorItem> DORNISH_HELMET = INSTANCE.addDyeableMedievalArmorItem("dornish_helmet", ModArmorTypes.DORNISH_ARMOR, ArmorItem.Type.HELMET, new Item.Properties(), 0xFF6A00);
    public static final @Nullable RegistrySupplier<DyeableMedievalArmorItem> DORNISH_CHESTPLATE = INSTANCE.addDyeableMedievalArmorItem("dornish_chestplate", ModArmorTypes.DORNISH_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Properties(), 0xFF6A00);
    public static final @Nullable RegistrySupplier<DyeableMedievalArmorItem> DORNISH_LEGGINGS = INSTANCE.addDyeableMedievalArmorItem("dornish_leggings", ModArmorTypes.DORNISH_ARMOR, ArmorItem.Type.LEGGINGS, new Item.Properties(),0xFF6A00);
    public static final @Nullable RegistrySupplier<DyeableMedievalArmorItem> DORNISH_BOOTS = INSTANCE.addDyeableMedievalArmorItem("dornish_boots", ModArmorTypes.DORNISH_ARMOR, ArmorItem.Type.BOOTS, new Item.Properties(),0xFF6A00);

    public static final @Nullable RegistrySupplier<MedievalArmorItem> DORNISH_PRINCE_HELMET = INSTANCE.addMedievalArmorItem("dornish_noble_helmet", ModArmorTypes.DORNISH_PRINCE_ARMOR, ArmorItem.Type.HELMET, new Item.Properties());
    public static final @Nullable RegistrySupplier<DyeableMedievalArmorItem> DORNISH_PRINCE_CHESTPLATE = INSTANCE.addDyeableMedievalArmorItem("dornish_noble_chestplate", ModArmorTypes.DORNISH_PRINCE_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Properties(), 0xFF6A00);
    public static final @Nullable RegistrySupplier<DyeableMedievalArmorItem> DORNISH_PRINCE_LEGGINGS = INSTANCE.addDyeableMedievalArmorItem("dornish_noble_leggings", ModArmorTypes.DORNISH_PRINCE_ARMOR, ArmorItem.Type.LEGGINGS, new Item.Properties(),0xFF6A00);
    public static final @Nullable RegistrySupplier<DyeableMedievalArmorItem> DORNISH_PRINCE_BOOTS = INSTANCE.addDyeableMedievalArmorItem("dornish_noble_boots", ModArmorTypes.DORNISH_PRINCE_ARMOR, ArmorItem.Type.BOOTS, new Item.Properties(),0xFF6A00);
    ...
    public static final @Nullable RegistrySupplier<MedievalArmorItem> RICH_GREYJOY_HELMET = INSTANCE.addMedievalArmorItem("heavy_greyjoy_helmet", ModArmorTypes.RICH_GREYJOY_ARMOR, ArmorItem.Type.HELMET, new Item.Properties());
    public static final @Nullable RegistrySupplier<MedievalArmorItem> RICH_GREYJOY_CHESTPLATE = INSTANCE.addMedievalArmorItem("heavy_greyjoy_chestplate", ModArmorTypes.RICH_GREYJOY_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Properties());
    public static final @Nullable RegistrySupplier<MedievalArmorItem> RICH_GREYJOY_LEGGINGS = INSTANCE.addMedievalArmorItem("heavy_greyjoy_leggings", ModArmorTypes.RICH_GREYJOY_ARMOR, ArmorItem.Type.LEGGINGS, new Item.Properties());
    public static final @Nullable RegistrySupplier<MedievalArmorItem> RICH_GREYJOY_BOOTS = INSTANCE.addMedievalArmorItem("heavy_greyjoy_boots", ModArmorTypes.RICH_GREYJOY_ARMOR, ArmorItem.Type.BOOTS, new Item.Properties());
    ...
    public static final @Nullable RegistrySupplier<MedievalArmorItem> PLATE_NORTHERN_HELMET = INSTANCE.addMedievalArmorItem("plate_northern_helmet", ModArmorTypes.PLATE_NORTHERN_ARMOR, ArmorItem.Type.HELMET, new Item.Properties());
    public static final @Nullable RegistrySupplier<MedievalArmorItem> PLATE_NORTHERN_CHESTPLATE = INSTANCE.addMedievalArmorItem("plate_northern_chestplate", ModArmorTypes.PLATE_NORTHERN_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Properties());
    public static final @Nullable RegistrySupplier<MedievalArmorItem> PLATE_NORTHERN_LEGGINGS = INSTANCE.addMedievalArmorItem("plate_northern_leggings", ModArmorTypes.PLATE_NORTHERN_ARMOR, ArmorItem.Type.LEGGINGS, new Item.Properties());
    public static final @Nullable RegistrySupplier<MedievalArmorItem> PLATE_NORTHERN_BOOTS = INSTANCE.addMedievalArmorItem("plate_northern_boots", ModArmorTypes.PLATE_NORTHERN_ARMOR, ArmorItem.Type.BOOTS, new Item.Properties());
    ...
    public static final RegistrySupplier<WearableArmorDecorationItem> AEGON_DRAGONSBANE_CROWN_DECORATION = INSTANCE.addWearableArmorDecorationItem("aegon_dragonsbane_crown_decoration", ModArmorTypes.AEGON_DRAGONBANE_CROWN, ArmorItem.Type.HELMET, new Item.Properties());
    ...
    public static final RegistrySupplier<WearableArmorDecorationItem> STANNIS_CROWN_DECORATION = INSTANCE.addWearableArmorDecorationItem("stannis_crown_decoration", ModArmorTypes.STANNIS_CROWN, ArmorItem.Type.HELMET, new Item.Properties());
    public static final RegistrySupplier<WearableArmorDecorationItem> RENLY_CROWN_DECORATION = INSTANCE.addWearableArmorDecorationItem("renly_crown_decoration", ModArmorTypes.RENLY_CROWN, ArmorItem.Type.HELMET, new Item.Properties());
    public static final RegistrySupplier<WearableArmorDecorationItem> STARK_CROWN_DECORATION = INSTANCE.addWearableArmorDecorationItem("stark_crown_decoration", ModArmorTypes.STARK_CROWN, ArmorItem.Type.HELMET, new Item.Properties());
    public static final RegistrySupplier<WearableArmorDecorationItem> DRIFTWOOD_CROWN_DECORATION = INSTANCE.addWearableArmorDecorationItem("driftwood_crown_decoration", ModArmorTypes.DRIFTWOOD_CROWN, ArmorItem.Type.HELMET, new Item.Properties());
    public static final RegistrySupplier<DyeableArmorDecorationItem> FANCY_CAPE_DECORATION = INSTANCE.addDyeableArmorDecorationItem("fancy_cape_decoration", () -> new DyeableArmorDecorationItem(ResourceLocation.fromNamespaceAndPath(ASOIAFMod.MOD_ID, "fancy_cape"), new Item.Properties(), ArmorItem.Type.CHESTPLATE, 0xFFFFFF));
    public static final RegistrySupplier<ArmorDecorationItem> NIGHT_WATCH_CAPE_DECORATION = INSTANCE.addArmorDecorationItem("night_watch_cape_decoration", () -> new ArmorDecorationItem(ResourceLocation.fromNamespaceAndPath(ASOIAFMod.MOD_ID, "night_watch_cape"), new Item.Properties(), ArmorItem.Type.CHESTPLATE));
    public static final RegistrySupplier<ArmorDecorationItem> PALE_FUR_CAPE_DECORATION = INSTANCE.addArmorDecorationItem("fur_cape_pale_decoration", () -> new ArmorDecorationItem(ResourceLocation.fromNamespaceAndPath(ASOIAFMod.MOD_ID, "fur_cape_pale"), new Item.Properties(), ArmorItem.Type.CHESTPLATE));
    public static final RegistrySupplier<ArmorDecorationItem> WHITE_FUR_CAPE_DECORATION = INSTANCE.addArmorDecorationItem("fur_cape_white_decoration", () -> new ArmorDecorationItem(ResourceLocation.fromNamespaceAndPath(ASOIAFMod.MOD_ID, "fur_cape_white"), new Item.Properties(), ArmorItem.Type.CHESTPLATE));
    public static final RegistrySupplier<ArmorDecorationItem> BLACK_FUR_CAPE_DECORATION = INSTANCE.addArmorDecorationItem("fur_cape_black_decoration", () -> new ArmorDecorationItem(ResourceLocation.fromNamespaceAndPath(ASOIAFMod.MOD_ID, "fur_cape_black"), new Item.Properties(), ArmorItem.Type.CHESTPLATE));
    public static final RegistrySupplier<ArmorDecorationItem> WOODS_FUR_CAPE_DECORATION = INSTANCE.addArmorDecorationItem("fur_cape_woods_decoration", () -> new ArmorDecorationItem(ResourceLocation.fromNamespaceAndPath(ASOIAFMod.MOD_ID, "fur_cape_woods"), new Item.Properties(), ArmorItem.Type.CHESTPLATE));
    public static final RegistrySupplier<DyeableArmorDecorationItem> LANNISTER_CAPE_DECORATION = INSTANCE.addDyeableArmorDecorationItem("lannister_cape_decoration", () -> new DyeableArmorDecorationItem(ResourceLocation.fromNamespaceAndPath(ASOIAFMod.MOD_ID, "fancy_cape"), new Item.Properties(), ArmorItem.Type.CHESTPLATE, 0xB02E26));
    public static final RegistrySupplier<DyeableArmorDecorationItem> GOLD_CLOAK_LEFT_DECORATION = INSTANCE.addDyeableArmorDecorationItem("gold_cloak_left_decoration", () -> new DyeableArmorDecorationItem(ResourceLocation.fromNamespaceAndPath(ASOIAFMod.MOD_ID, "gold_cloak_left"), new Item.Properties(), ArmorItem.Type.CHESTPLATE, 0xFFFFFF));
    public static final RegistrySupplier<DyeableArmorDecorationItem> GOLD_CLOAK_RIGHT_DECORATION = INSTANCE.addDyeableArmorDecorationItem("gold_cloak_right_decoration", () -> new DyeableArmorDecorationItem(ResourceLocation.fromNamespaceAndPath(ASOIAFMod.MOD_ID, "gold_cloak_right"), new Item.Properties(), ArmorItem.Type.CHESTPLATE, 0xFFFFFF));
    public static final RegistrySupplier<ArmorDecorationItem> DRAGON_DECORATION = INSTANCE.addArmorDecorationItem("dragon_decoration", () -> new ArmorDecorationItem(ResourceLocation.fromNamespaceAndPath(ASOIAFMod.MOD_ID, "dragon"), new Item.Properties(), ArmorItem.Type.HELMET));
    public static final RegistrySupplier<ArmorDecorationItem> WINGS_DECORATION = INSTANCE.addArmorDecorationItem("wings_decoration", () -> new ArmorDecorationItem(ResourceLocation.fromNamespaceAndPath(ASOIAFMod.MOD_ID, "wings"), new Item.Properties(), ArmorItem.Type.HELMET));
    public static final RegistrySupplier<ArmorDecorationItem> FIN_DECORATION = INSTANCE.addArmorDecorationItem("fin_decoration", () -> new ArmorDecorationItem(ResourceLocation.fromNamespaceAndPath(ASOIAFMod.MOD_ID, "fin"), new Item.Properties(), ArmorItem.Type.HELMET));
    ...
    public static final RegistrySupplier<Item> LIZARD_PATTERN = INSTANCE.addIngredientItem("lizard_pattern", () -> new BannerPatternItem(ModBannerPatternTags.LIZARD_PATTERN, new Item.Properties().stacksTo(1)));
    public static final RegistrySupplier<Item> LILIES_PATTERN = INSTANCE.addIngredientItem("lilies_pattern", () -> new BannerPatternItem(ModBannerPatternTags.LILIES_PATTERN, new Item.Properties().stacksTo(1)));
